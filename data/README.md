The data in this folder contains the RAPTOR data used for my analysis, along with other NBA statistics, for every player grouped by team, season and season_type (regular season, playoffs) since 2014. 
