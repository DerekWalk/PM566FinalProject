...
**Figure 3.** The scatterplot above depicts the relationship between minutes played and total RAPTOR score. Based on the scatterplot we observe a moderately positive association, with a correlation of ⍴(rho)= 0.45 between the two variables. There is also large variance within the players that played a fewer amount of minutes.
...
**Figure 5.** The scatterplot above displays the positive association between player minutes played and offensive RAPTOR score. The correlation value for this relationship is ⍴(rho) = 0.48, which is slightly higher than the ⍴ value for the correlation between player minutes played and total RAPTOR score.

**Figure 6.** The scatterplot above displays the association between player minutes played and defensive RAPTOR score. Again, we observe a slightly positive association between the two variables, and obtain a ⍴(rho) value of 0.18 for the correlation. Clearly, this positive association is not as strong as the positive association observed between both minutes played vs. offensive RAPTOR score, and minutes played vs. total RAPTOR score. 
